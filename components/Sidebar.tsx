...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView }) => {
  return (
    <div className="w-20 lg:w-64 flex-shrink-0 bg-white m-4 rounded-3xl flex flex-col justify-between shadow-sm h-[calc(100vh-2rem)] transition-all duration-300">
      <div>

  ...
  return (
    <div className="space-y-6 animate-fade-in">
       <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-dark">Fatture</h1>
          <p className="text-gray-500 mt-1">Gestione fatturazione e pagamenti</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-[2rem] shadow-sm border-l-4 border-red-400">
            <h3 className="text-gray-500 text-sm font-medium">Scadute</h3>
            <p className="text-3xl font-bold text-dark mt-2">€ 12.500,50</p>
            <p className="text-xs text-red-500 mt-1 font-medium">Azione richiesta</p>
        </div>
        <div className="bg-white p-6 rounded-[2rem] shadow-sm border-l-4 border-yellow-400">
            <h3 className="text-gray-500 text-sm font-medium">In attesa</h3>
            <p className="text-3xl font-bold text-dark mt-2">€ 2.400,00</p>
            <p className="text-xs text-gray-400 mt-1">Scadenza 30 gg</p>
        </div>
        <div className="bg-white p-6 rounded-[2rem] shadow-sm border-l-4 border-primary">
            <h3 className="text-gray-500 text-sm font-medium">Pagate questo mese</h3>
            <p className="text-3xl font-bold text-dark mt-2">€ 5.600,00</p>
            <p className="text-xs text-green-600 mt-1">+12% vs mese scorso</p>
        </div>
      </div>
            ...
            <table className="w-full">
                <thead className="bg-gray-50">
                    <tr className="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                        <th className="px-6 py-4 rounded-tl-2xl">Fattura N.</th>

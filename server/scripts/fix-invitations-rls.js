/**
 * Fix RLS policy on user_invitations table
 * Allows company members to see all company invitations
 */
...
async function fixInvitationsRLS() {
  try {
    console.log('🔧 Fixing user_invitations RLS policy...');
    ...
    console.log('  - Invitations sent to their email');
